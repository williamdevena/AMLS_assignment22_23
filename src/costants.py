...
PATH_CELEBA_TRAIN_CROPPED_MOUTH_IMG = os.path.join(
    DATASETS_PATH, "celeba/img_static_cropped_mouth")
PATH_CELEBA_TRAIN_CROPPED_EYES_IMG = os.path.join(
    DATASETS_PATH, "celeba/img_static_cropped_eyes")
...
PATH_CELEBA_TRAIN_DYN_CROPPED_FACE_IMG = os.path.join(
    DATASETS_PATH, "celeba/img_dyn_cropped_face")
...
PATH_CELEBA_TEST_CROPPED_MOUTH_IMG = os.path.join(
    DATASETS_PATH, "celeba_test/img_static_cropped_mouth")
PATH_CELEBA_TEST_CROPPED_EYES_IMG = os.path.join(
    DATASETS_PATH, "celeba_test/img_static_cropped_eyes")
...
PATH_CELEBA_TEST_DYN_CROPPED_FACE_IMG = os.path.join(
    DATASETS_PATH, "celeba_test/img_dyn_cropped_face")
...
PATH_CARTOON_TRAIN_FOLDER = os.path.join(DATASETS_PATH, "cartoon_set")

PATH_CARTOON_TRAIN_IMG = os.path.join(DATASETS_PATH, "cartoon_set/img")
PATH_CARTOON_TRAIN_CROPPED_EYE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set/img_static_cropped_eye")
PATH_CARTOON_TRAIN_DYN_CROPPED_EYE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set/img_dyn_cropped_eye")
PATH_CARTOON_TRAIN_DYN_CROPPED_FACE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set/img_dyn_cropped_face")
...
# TESTING
PATH_CARTOON_TEST_FOLDER = os.path.join(DATASETS_PATH, "cartoon_set_test")

PATH_CARTOON_TEST_IMG = os.path.join(DATASETS_PATH, "cartoon_set_test/img")
PATH_CARTOON_TEST_CROPPED_EYE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set_test/img_static_cropped_eye")
PATH_CARTOON_TEST_DYN_CROPPED_EYE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set_test/img_dyn_cropped_eye")
PATH_CARTOON_TEST_DYN_CROPPED_FACE_IMG = os.path.join(
    DATASETS_PATH, "cartoon_set_test/img_dyn_cropped_face")
